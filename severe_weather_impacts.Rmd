...
To prepare the raw data fro analysis we must firts download and unpack the data
...
I could not locate a code table to explain these values seen in the exponent field, so some assumptions are necessary to create comparable values.  I will assume this mapping:
